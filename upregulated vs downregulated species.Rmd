...
```{r}
Taxonomic_blast_summary_upregulated <- read_excel("Taxonomic.blast.summary_up&down_mike.xlsx")

Taxonomic_blast_summary_downregulated <- read_excel("Taxonomic.blast.summary_up&down_mike.xlsx", sheet = "Downregulated")
